...
lineaccesstoken = 'vMQ7pmWzkLGK9ohupnruCgZZGBjVoCsGnMQZTWUB04TGTFwAYAWO3k8waPMNe4OmAGK6zo8SVnWX+ledp/at4LzIUN1Is/mv66mdnY4DescZ8SeLuI3LK+ZCYkU6ES8n8N1mZX2eQ1jTDioqisNNowdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี":
            replyObj = TextSendMessage(text="โทดนะ เป็นอะไร๊หร๊อ")
            ine_bot_api.reply_message(rtoken, replyObj)
        elif msg == "รักเรามั้ย":
            replyObj = TextSendMessage(text="เอ็งบ้าป่าวไอ้ชาย")
            ine_bot_api.reply_message(rtoken, replyObj)
        elif msg == "ใจร้าย":
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/c6331b88-abc4-4592-86fe-4d756e52f3ee"
